  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
		...
		<i class="bi bi-grid"></i><span>Laporan</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?= base_url('laporan')?>">
              <i class="bi bi-circle"></i><span>Laporan Data Pasien</span>
            </a>
          </li>
          <li>
            <a href="<?= base_url('laporan')?>">
              <i class="bi bi-circle"></i><span>Laporan Data Lahiran</span>
            </a>
          </li>
          <li>
            <a href="">
              <i class="bi bi-circle"></i><span>Laporan Data Periksa Kehamilan</span>
            </a>
          </li>
          <li>
            <a href="">
              <i class="bi bi-circle"></i><span>Laporan Rekam Medis</span>
            </a>
          </li>
        </ul>
      </li>
