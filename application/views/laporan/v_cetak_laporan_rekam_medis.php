        ...
        <div class="panel panel-default">
            ...
            <div class="card-body">
                <div class="dataTableWrapper">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('rekam_medis/cetak_laporan')?>" class="btn btn-primary">Print View</a>
                                            <a href="<?= base_url('rekam_medis/print_laporan')?>" class="btn btn-warning">Print</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <hr class="line-title">
				<form action="<?php echo base_url('rekam_medis/view'); ?>" method="post">
                <fieldset class="card-body">
                    <tabel>
                        <tbody>
