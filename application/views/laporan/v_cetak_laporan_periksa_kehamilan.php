        ...
        <div class="panel panel-default">
            ...
            <div class="card-body">
                <div class="dataTableWrapper">
                    ...
                    <h3> Cetak Laporan Periksa Kehamilan</h3>
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('periksa_kehamilan/cetak_laporan')?>" class="btn btn-primary">Print View</a>
                                            <a href="<?= base_url('periksa_kehamilan/print_laporan')?>" class="btn btn-warning">Print</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <hr class="line-title">
                    <form action="<?php echo base_url('periksa_kehamilan/view'); ?>" method="post">
                <fieldset class="card-body">
                    <tabel>
                        <tbody>
